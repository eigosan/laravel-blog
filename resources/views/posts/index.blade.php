...
@section('content')
  ...
  <x-turbo::frame id="posts">
    <div class="d-flex justify-content-between gap-3 mt-3">
      ...
      <div class="p-2">
        <!-- Create Post Button (only visible for admins and editors) -->
        @can('create', App\Models\Post::class) <!-- Ensure the user can create posts -->
          <a href="{{ route('posts.create') }}" class="btn btn-primary">
            @lang('forms.actions.create_post') <!-- Customize the text here -->
          </a>
        @endcan
        <!-- RSS Link -->
